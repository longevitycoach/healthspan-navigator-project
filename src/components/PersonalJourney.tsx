    ...
    },
    {
      ...
      description: (
        <>
          ...
          <p className="mb-4">
            Applied cutting-edge AI development methodologies following agile DevOps based Software Development Life Cycle (SDLC), implementing the BMAD (Breakthrough Method for Agile AI-Driven Development) framework integrated into the SDLC process. BMAD utilizes specialized AI agents (Analyst, PM, Architect, Scrum Master, Dev, QA) for agentic planning and context-engineered development. Leveraged Windsurf for collaborative development, Lovable for rapid prototyping, Claude Code for AI-assisted programming, and MCP Servers for scalable backend architecture.
          </p>
